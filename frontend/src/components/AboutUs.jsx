    ...
    <div className="font-sans text-[#FCE4EC] bg-[#8B2321] min-h-screen py-16 px-6 sm:px-12 md:px-24">
      ...
      <div className="relative bg-[#FFDAB9] py-16 px-6 sm:px-12 md:px-20">
        <div className="text-center md:text-left mx-auto max-w-4xl text-[#8B2321]">
          ...
          <p className="text-lg">
            From classic candies to unique creations, we take pride in our diverse
            selection. Each sweet is a small work of art, made to delight your
            senses and satisfy your cravings. We are constantly experimenting to
            bring you the next perfect treat.
          </p>
        </div>
      </div>
      ...
      <div className="mt-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-2xl font-bold text-[#8B2321] mb-4">Quality Ingredients</h3>
          ...
          {/* Box 2 */}
          <div className="bg-white p-8 rounded-2xl shadow-xl transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-2xl font-bold text-[#8B2321] mb-4">Handcrafted with Love</h3>
            <p className="text-[#8B2321]">
          ...
          {/* Box 3 */}
          <div className="bg-white p-8 rounded-2xl shadow-xl transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-2xl font-bold text-[#8B2321] mb-4">Unique Flavors</h3>
            <p className="text-[#8B2321]">
              We constantly innovate to bring you unique and exciting flavor combinations.
            </p>
          </div>
          {/* Box 4 */}
          <div className="bg-white p-8 rounded-2xl shadow-xl transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-2xl font-bold text-[#8B2321] mb-4">Customer Delight</h3>
            <p className="text-[#8B2321]">
              Your happiness is our top priority, and we strive to provide the best service.
            </p>
          </div>
        </div>
      </div>
